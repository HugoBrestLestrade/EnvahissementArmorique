...
/**
 * Represents a Fantastic Creature character.
 * Fantastic creatures are magical beings with special abilities.
 * They belong to the "Créature" faction.
 *
...
public class FantasticCreature extends GameCharacter {
    ...
    /**
     * Creates a new Fantastic Creature character.
     * The faction is automatically set to "Créature".
     *
